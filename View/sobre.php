...
<body>
    ...
    <div class="container-sphere">
        ...
        <div class="person">
            <div class="semi-sphere">
                <h2>Murilo Neves Matutino</h2><br>
                <p>Discente do IFBA Campus Seabra ingressado no ano de 2023.</p><br>
                <a href="https://www.github.com/murilomatutino" target="_blank"><img title="Clique para acessar o GitHub" src="assets/murilo.jpeg" alt="Foto da Pessoa 3" class="img-sobre" onerror="this.src='assets/person.png'" draggable="false"></a>
            </div>
        </div>
    </div>
    </main>
